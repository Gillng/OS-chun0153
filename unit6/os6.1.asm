...
.segmentdef Zeropage [min=$bf00, max=$bfff, fill]
  ...
  .label pid_counter = $36
  .label lpeek_value = $37
  .label current_screen_line = $14
  .label current_screen_x = $1a
...
// memset(void* zeropage($65) str, byte register(X) c, word zeropage($67) num)
memset: {
    .label end = $67
    .label dst = $65
    .label num = $67
...
// dequeue_message(byte zeropage($6a) message_num)
dequeue_message: {
    .label message_num = $6a
    .label dest = $6b
    .label src = $6d
    lda.z ipc_message_count
    cmp.z message_num
...
// get_next_message_id(byte zeropage($69) receiver)
get_next_message_id: {
    .label receiver = $69
    .label m = $6f
    .label best_message = $6a
    lda #$ff
    sta.z best_message
    ldx #0
  __b1:
...
.segment Code
// print_hex(word zeropage($17) value)
print_hex: {
    .label __3 = $73
    .label __6 = $75
    .label value = $17
