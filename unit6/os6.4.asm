...
// The functions are placed in the SYSCALLS table surrounded by JMP and NOP
  .file [name="os6.4.bin", type="bin", segments="XMega65Bin"]
...
// lpeek(dword zeropage($58) address)
lpeek: {
    .label t = $2e
    .label address = $58
...
// initialise_pdb(byte zeropage($f) pdb_number, byte* zeropage($56) name)
initialise_pdb: {
    .label __1 = $60
    .label __2 = $60
    .label __9 = $62
...
// memset(void* zeropage($6a) str, byte register(X) c, word zeropage($56) num)
memset: {
    .label end = $56
    .label dst = $6a
    .label num = $56
...
// queue_message(byte register(Y) from, byte register(X) to, byte zeropage($6e) priority, byte zeropage($6f) sequence)
queue_message: {
    .label __10 = $72
    .label priority = $6e
    .label sequence = $6f
...
// dequeue_message(byte zeropage($75) message_num)
dequeue_message: {
    .label message_num = $75
    .label dest = $76
    .label src = $78
    lda.z ipc_message_count
    cmp.z message_num
...
// get_next_message_id(byte zeropage($74) receiver)
get_next_message_id: {
    .label receiver = $74
    .label m = $7a
    .label priority = $15
    .label best_message = $75
    lda #0
    sta.z priority
    lda #$ff
    sta.z best_message
